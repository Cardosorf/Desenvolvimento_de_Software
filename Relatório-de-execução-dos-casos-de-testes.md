...
|CT02_03|Aid do projeto ,titulo,epigrafe,status,descriação,tema,segmentos do projeto , numero de propostas e data do projeto|o sistema notifica se algum dos campos vem null|seleciona|
